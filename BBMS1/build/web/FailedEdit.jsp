...
<html>
    ...
    <body>
        <div class="container-fluid">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h2 class="text-center fw-normal">You need to login First to access this feature!!</h2>
                        </div>
            ...
            <h1 class="text-center text-danger" id="h1">We didn't found such Account for Updating!!</h1>
            <h2 class="text-center mt-4">Try Again or return to home page</h2>
            <p class="text-center"><a href="Edit.jsp" class="mt-4 fs-1 btn btn-warning">Update Account</a></p>
        </div>
