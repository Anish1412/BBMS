...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <h1 class="text-center text-danger fw-light">ADD HOSPITAL</h1>
            <form action="AddHospital" method="post">
                <div class="row justify-content-center">
                    <div class="col-md-6 col-10 col-lg-4 col-sm-8 mt-2 p-5">
                        <div class="form-group">
                            <input type="text" placeholder="HospitalName" name="HName" class="form-control" autocomplete="off" required/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row mt-3 text-center">
                            <div class="col-md-12">
                                <input type="submit" value="ADD" class="btn btn-primary px-5 fs-1 justify-content-center">  
                            </div>
                        </div>
                    </div>
                </div>
