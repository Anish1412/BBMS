 ...
 * @author anish
 */
@WebServlet(urlPatterns = {"/Blood_Request"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (i > 0) {
                ...
                out.println("<a href=\"Blood_Order.jsp\" class=\"btn btn-success px-5 py-2 fs-2 mt-4 mx-2\">Buy BloodBag</a>");
                out.println("<a href=\"BloodBank.jsp\" class=\"btn btn-danger px-5 py-2 fs-2 mt-4\">Cancel</a>");
                out.println("</div>");
                out.println("</div>");
                out.println("</div>");
