 ...
 * @author anish
 */
@WebServlet(urlPatterns = {"/UpdateBloodBank"})
public class UpdateBloodBank extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps = c.prepareStatement("update BloodBank set BloodBankName=?,Location=?,Email=?,Telephone=? where Telephone=?");
