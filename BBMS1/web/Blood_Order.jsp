            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4 col-10 col-xs-12">
                    <div class="service-item second-service">
                        ...
                        <a href="Blood_Request.jsp" class="btn btn-success px-5 py-2 fs-2 mt-4 mx-2">Order again</a>
                        <a href="BloodBank.jsp" class="btn btn-danger px-5 py-2 fs-2 mt-4">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
