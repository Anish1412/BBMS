...
<html>
    ...
    <body>
        <div class="container-fluid">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h2 class="text-center">Return to Home page & then login to access this feature!!</h2>
                        </div>
            ...
            <h1 class="text-center text-danger" style="margin-top: 115px;">Delete Account</h1>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6 col-10 col-lg-4 col-sm-8 mt-2 p-4">
                        ...
                        <div class="row mt-3 text-center">
                            <div class="col-md-12">
                                <input type="submit" value="Delete" class="btn btn-danger px-5 justify-content-center fs-3"> 
                            </div>
                        </div>
                    </div>
                </div>
