...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <h1 class="text-center" id="h1">You may got error due to the following conditions :-</h1>
            <ul class="text-center">
                <li>1) Email</li>
                <li>2) Mobile number</li>
                <li>3) Password</li>
            </ul>
            <h2 class="text-center">Any of the above fields you entered may be already registered, try with some other information.</h2>
        </div>
