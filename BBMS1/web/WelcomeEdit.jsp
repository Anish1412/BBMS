...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <h1 class="text-center fw-semibold" id="h1">YOU HAVE UPDATED YOUR ACCOUNT SUCCESSFULLY!!</h1>
            <p class="text-center"><a href="login.jsp" class="mt-5 fs-2 btn btn-primary text-white">Login</a><a href="Edit.jsp" class="mt-5 fs-2 btn btn-warning mx-3">Update</a><a href="Delete.jsp" class="mt-5 fs-2 btn btn-danger text-white ">Delete</a></p>
        </div>
